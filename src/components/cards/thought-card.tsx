...
export default function ThoughtCard({
  ...
  return (
    <Link href={`/thought/${id}`}>
      <article className='flex w-full flex-col rounded-lg bg-zinc-50 dark:bg-zinc-900 border p-6 text-zinc-950 dark:text-zinc-50'>
        <div className='flex items-start justify-between'>
          <div className='w-full flex flex-1 gap-4'>
            <div className='flex flex-col items-center justify-center'>
              ...
              <div className='relative w-[1px] mt-2 grow rounded-full bg-zinc-300   dark:bg-zinc-700' />
            </div>
